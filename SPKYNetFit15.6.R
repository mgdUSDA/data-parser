cat("\n Sparky Systems data parser.  ", "Last edited: June 16, 2015.\n\n")
...
# To execute type: source("SPKYNetFit15.6.R", print.eval = TRUE)
...
setDataDir = function(){
  dirOut[1] = "C:/Labwork/SparkyJr/"
  dirOut[2] = "C:/Labwork/Sparky3/"
  dirOut[3] = "C:/Labwork/BlackBear/"
  dir.create(dirOut[1], recursive = TRUE)
  dir.create(dirOut[2], recursive = TRUE)
  dir.create(dirOut[3], recursive = TRUE)
}
...
setSPKY3Dir = function(){
  ...
  if (!is.na(file.info(testDir1)$isdir)){
    ...
    if (!is.na(file.info(testDir1)$isdir)){
      ...
      if (!is.na(file.info(testDir1)$isdir)){
        # Working from M65
        print(paste("Found", testDir1, ".  Must be working from M65."))
        dir1 = "U:/DATA/*.txt"
        dir2 =  "V:/1/DATA/*.txt"
        dirOut = "C:/LabWork/Sparky3/*.csv"
        dirParser = "C:/Labwork"
        dirReport = "C:/LabWork/Sparky3/"
        dirWork = "C:/Users/USDA-ARS-Soils526/LabWork/Data processing/R"
      } else { 
  ...
  if (!is.na(file.info(testDir1)$isdir)){
    ...
    if (!is.na(file.info(testDir1)$isdir)){
      ...
      if (!is.na(file.info(testDir1)$isdir)){
        ...
        dir1 = "W:/1/DATA/*.txt"
        dir2 =  "W:/2/DATA/*.txt"
        dirOut = "C:/LabWork/SparkyJr/*.csv"
        dirParser = "C:/Labwork"
        dirReport = "C:/LabWork/SparkyJr/"
        dirWork = "C:/Users/USDA-ARS-Soils526/LabWork/Data processing/R"
      } else {
        # None of the above.  Find your own way.
        print("Could not find any of the expected file paths.  Paths all set to C:/")
...
if (gc == 1){
  ...
  print("Try to loacate FIDData automatically.")
  infile1 = infile2
  if ("\\\\2" %in% infile1)
